...
export default function Card() {
  ...
  return (
    <div>
      <span>Done</span>
      <Text title="Design Profile Page" className='text-white w-'/>
      <Text title="we need to redesign a profile, There are many examples you can try to use." className='text-white' />
      <div>
        <span>28 Mar</span>
      </div>
    </div>
