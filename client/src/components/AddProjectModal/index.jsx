        ...
        openProject ?
          <div className='modall'>
            <div className='content'>
              ...
              >
                <Text text={'Add new project'} className={'mt-2 ms-1 text-white'} />
                ...
                <div className='d-flex justify-content-center align-items-center mt-4'>
                  <SubmitButton title="Add" className="btn btn-primary d-flex justify-content-center me-2 submit-btn" />
                  <Button title={'Cancel'} className={'d-flex justify-content-center cancel-btn'} onClick={() => dispatch(setProjectOpen(false))} />
                </div>
              </Form>
            </div>
          </div>
